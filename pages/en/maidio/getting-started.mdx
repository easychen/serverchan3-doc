...
2. Android users: [Download APK](https://the7.ft07.com/Maidio/maidio-byok-1.0.10-b31.apk) (v1.0.10) and install manually

For a complete tutorial: [Watch on Youtube](https://www.youtube.com/watch?v=N5PRf87xtkQ)

[![](../../../images/20250113175319.png)](https://www.youtube.com/watch?v=N5PRf87xtkQ)
...
3. For Android systems:
   - Install multiple TTS engines in system settings first
   - For Chinese, recommended to use [Xiaomi](https://www.52pojie.cn/thread-1683594-1-1.html) and [Google](https://play.google.com/store/apps/details?id=com.google.android.voiceservices) voice engines
   - Select appropriate voices
4. For iOS systems:
   - Go to "Settings" → "Accessibility" → "Spoken Content" and enable "Speak Selection"
   - "Voices" → "Your language" → "Download high-quality voices"
   - Then you can select them in local TTS (restart app if the voice is not visible)
