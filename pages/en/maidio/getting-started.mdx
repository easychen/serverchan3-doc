...
3. Enter your API Key from AI platforms:
   - iOS version currently supports:
      - [SiliconFlow.cn](https://cloud.siliconflow.cn/i/GKAoff2O): A leading open-source model service provider in China. Create API KEY after registration
   
   - Android version currently supports:
      - [API2D](https://api2d.com/r/186008): A one-stop AI API distribution and value-added platform located in Canada. Create API KEY after registration, supports WeChat payment
      - [SiliconFlow.cn](https://cloud.siliconflow.cn/i/GKAoff2O): A leading open-source model service provider in China. Create API KEY after registration
